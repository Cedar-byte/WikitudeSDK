...
public class SampleCamActivity extends AbstractArchitectCamActivity {
	...
	public String getARchitectWorldPath() {
		Log.i("hehehehehehehehehehehehe", "getARchitectWorldPath: " + getIntent().getExtras().getString(
	...
	protected boolean hasGeo() {
		Log.i("落个日志", "hasGeo: " + getIntent().getExtras().getBoolean(
	...
	protected boolean hasIR() {
		Log.i("落个日志hasIR", "hasIR: " + getIntent().getExtras().getBoolean(
